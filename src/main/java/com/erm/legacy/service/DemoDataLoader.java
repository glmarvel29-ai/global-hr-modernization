...
public class DemoDataLoader implements CommandLineRunner {
    ...
    private void save(String prefix, String num, String title, RiskDomain domain,
                      String severity, String status, String owner, String description) {
